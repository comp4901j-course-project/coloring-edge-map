...
def convert_h5py(task_name):
    ...
    base_dir = os.path.join('/content/drive/My Drive/Colab Notebooks/Cycle/datasets', task_name)
...
def read_h5py(task_name, image_size):
    base_dir = '/content/drive/My Drive/Colab Notebooks/Cycle/datasets/' + task_name
    ...
    for dir_name in ['trainA', 'trainB', 'testA', 'testB']:
        try:
            print(os.path.join(base_dir, '{}_{}.hy'.format(dir_name, image_size)))
...
def get_data(task_name, image_size):
    ...
    if not os.path.exists('/content/drive/My Drive/Colab Notebooks/Cycle/datasets'):
        os.makedirs('/content/drive/My Drive/Colab Notebooks/Cycle/datasets')
